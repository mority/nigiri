...
TEST(dominates, basic) {
  ...
  EXPECT_EQ(-1, dominates(1, 0, 1, 1));
  EXPECT_EQ(0, dominates(0, 0, 0, 0));
  EXPECT_EQ(0, dominates(0, 1, 1, 0));
  EXPECT_EQ(0, dominates(1, 0, 0, 1));
  EXPECT_EQ(1, dominates(1, 1, 0, 1));
