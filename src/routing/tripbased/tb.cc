...
void transfer_set::add(transport_idx_t const transport_idx_from, location_idx_t const location_idx_from, transfer const& t) {
  assert(!finalized_);
...
std::optional<entry> transfer_set::get_transfers(transport_idx_t const transport_idx_from, location_idx_t const location_idx_from) {
  assert(finalized_);
